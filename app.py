...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///data.db?charset=utf-8'
...
users = utils.add_users_data(User, utils.read_json_file('data/users_data.json'))

db.session.add_all(users)
db.session.commit()

orders = utils.add_orders_data(Order, utils.read_json_file('data/orders_data.json'))

db.session.add_all(orders)
db.session.commit()

offers = utils.add_offers_data(Offer, utils.read_json_file('data/offers_data.json'))
